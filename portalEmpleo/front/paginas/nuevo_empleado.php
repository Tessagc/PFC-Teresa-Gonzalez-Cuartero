                ...
                echo "<form action='../../back/acciones/crear_empleado.php' method='post' class='mx-auto w-75' enctype='multipart/form-data' name='nuevo_empleado'>
                    <fieldset class='form-group border border-3 rounded-5 border-primary mb-3'>
                        ...
                        <div class='mb-3 px-5'>
                            ...
                            <input type='text' id='telefono_personal' name='telefono_personal_nuevo' minlength=9 class='form-control' required>
                        </div>
                        
                        <div class='mb-3 px-5'>
                            <label for='gmail_contacto' class='form-label fw-semibold fs-5 text-primary'>Correo Electrónico de Contacto:</label>
                            <input type='email' id='gmail_contacto' name='gmail_contacto_nuevo' pattern='[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$'  class='form-control' required>
                        </div>
                        
                        <div class='mb-3 px-5'>
                            <label for='gmail_empresarial' class='form-label fw-semibold fs-5 text-primary'>Correo Electrónico Empresarial:</label>
                            <input type='email' id='gmail_empresarial' name='gmail_empresarial_nuevo' pattern='[a-zA-Z0-9._%+-]+@empresa\.com' class='form-control' required>
                        </div>

                        <div class='mb-3 px-5'>
                            <label for='puesto' class='form-label fw-semibold fs-5 text-primary'>Puesto</label>
                            <input type='text' id='puesto' name='puesto_nuevo' class='form-control' minlength=5 required>
                        </div>
